...
# add 10 words to the list when finished.
# create the game with this one word to make testing easier
words = ["car"]
secret_word = random.choice(words).lower()

def get_guess():
  
  # Set dashes to the length of the secret word and set amount of guesses 
